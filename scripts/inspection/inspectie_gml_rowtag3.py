...
# Ongeldige prefixes (tags die géén rowTag kunnen zijn)
invalid_prefixes = [
    't:', 'gml:pos', 'gml:Point', 'ko:', 'imgeo:', 'h:', 'oz:', 'kad:', 'creationDate'
]

# Sleutelwoorden die rowTags waarschijnlijk maken
valid_keywords = ['Member', 'featureMember', 'Object', 'cityObjectMember']

# Verwerk elk GML-bestand
for file in gml_files:
    path = os.path.join(gml_folder, file)

    # Lees 300 regels, sla lege regels en commentaar over
    ...
    # Filter voor geldige rowTag-kandidaten die ook daadwerkelijk in bestand voorkomen
    candidate_rowtags = {
